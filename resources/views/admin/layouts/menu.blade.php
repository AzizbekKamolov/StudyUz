        ...
        <ul class="accordion-menu">
            <li class="open active">
                ...
                <ul class="sub-menu" style="display: block;">
                    <li><a href=""><i class="fa fa-users"></i>Foydalanuvchilar</a></li>
                    <!-- Active Page -->
                    <li class="active"><a href="{{ route('permissions.index') }}"><i class="fa fa-key"></i>Ruxsatlar</a></li>
                    <li><a href=""><i class="fa fa-key"></i>Rollar</a></li>
                </ul>
            </li>
            <li>
