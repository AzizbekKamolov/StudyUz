            ...
            <ul class="list-inline justify-content-end">
                ...
                <li class="list-inline-item dropdown hidden-xs hidden-sm">
                    <a class="text-muted" href="javascript:void(0)" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset("assets/images/flags/usa.png") }}" class="mg-b-5 wd-20 img-fluid" alt="">
                    </a>
                    <ul class="dropdown-menu languages-dropdown shadow-2">
                        <li>
                            <a href="javascript:void(0)" data-lang="en"><img src="{{ asset("assets/images/flags/usa.png") }}" class="img-fluid wd-20" alt=""> <span>English-US</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-lang="es"><img src="{{ asset("assets/images/flags/spanish.png") }}" class="img-fluid wd-20" alt=""> <span>Spanish</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-lang="fr"><img src="{{ asset("assets/images/flags/french.png") }}" class="img-fluid wd-20" alt=""> <span>French</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-lang="gr"><img src="{{ asset("assets/images/flags/germany.png") }}" class="img-fluid wd-20" alt=""> <span>German</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-lang="ru"><img src="{{ asset("assets/images/flags/russia.png") }}" class="img-fluid wd-20" alt=""> <span>Russian</span></a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" data-lang="ru"><img src="{{ asset("assets/images/flags/united-kingdom.png") }}" class="img-fluid wd-20" alt=""> <span>English-UK</span></a>
                        </li>
                    </ul>
                </li>
