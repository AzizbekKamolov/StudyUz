            ...
            <div class="card mb-4 shadow-1">
                <div class="card-header">
                    <h4 class="card-header-title">
                        {{ __('form.attribute.add_attribute') }}
                    </h4>
                </div>
                <div class="card-body collapse show" id="collapse8">
                    <form class="needs-validation" action="{{ route("attributes.store") }}" method="post">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-control select2 select2-hidden-accessible" tabindex="-1"
                                    ...
                                    <option value="1" selected>{{ __('form.university.university') }}</option>
